...
export const SubscriptionManager = forwardRef((props: SubscriptionManagerProps, ref) => {
  const [show, setShow] = useState(false);
  const [checkedItems, setCheckedItems] = useState(new Array(props.subscriptions.length).fill(false));
  const [actualSubscriptions, setActualSubscriptions] = useState([""]);
